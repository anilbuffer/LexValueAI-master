...
import { getMockCaseValuations, getMockSettlementOutcomes, createMockSettlementOutcome } from '@/lib/mock-data'
...
export function CaseValuationTab({ caseData }: { caseData: any }) {
  ...
  const handleSaveOutcome = (e: React.FormEvent) => {
    ...
    const newOutcome = {
      ...
      timeToSettleDays: parseInt(outcomeForm.timeToSettleDays) || 120,
      closedDate: new Date(),
    ...
    <div className="flex flex-col h-full animate-in fade-in slide-in-from-bottom-2 duration-500 font-sans">
      ...
      <div className="bg-slate-50/90 p-5 md:p-6 border-b border-slate-200 shrink-0 flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 mt-1 max-w-3xl leading-relaxed">
            Structured settlement evaluation covering Value Drivers, Defense Pressure Points, Anticipated Carrier Position, and Actionable Strategy. Directional weights guide attorney judgment without synthetic dollar guessing.
          </p>
        </div>
        ...
        <div className="shrink-0 flex items-center gap-2.5 flex-wrap">
          ...
          >
            ...
            <span>Outcome Moat ({settlementOutcomes.length} Logged)</span>
          </button>
          ...
          >
            ...
            <span>Log Closed Settlement</span>
          </button>
        </div>
      </div>
      ...
      {saveSuccessMessage && (
        <div className="bg-emerald-50 border-b border-emerald-200 p-3 px-6 text-xs text-emerald-800 font-semibold flex items-center gap-2 animate-in fade-in">
          ...
          <span>Settlement outcome successfully recorded in your firm's private dataset. This historical data directly strengthens your settlement intelligence.</span>
        </div>
      )}
      ...
      <div className="p-5 md:p-8 flex-1 overflow-y-auto space-y-6 bg-slate-50/30">
        ...
        {/* 1. DIRECTIONAL LEVERAGE POSTURE (NO DOLLAR FIGURES) */}
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-sm font-bold uppercase tracking-wider text-slate-900">
                  Directional Case Leverage Spectrum
                </h3>
              </div>
        ...
        {/* 2 & 3. PART 1: VALUE DRIVERS VS PART 2: DEFENSE PRESSURE POINTS */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">

          {/* PART 1: VALUE DRIVERS */}
            ...
            <div>
              <div className="flex items-center justify-between mb-4 border-b border-slate-100 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-slate-900">Part 1: Value Drivers</h4>
          ...
          {/* PART 2: DEFENSE PRESSURE POINTS */}
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm flex flex-col justify-between">
            <div>
              <div className="flex items-center justify-between mb-4 border-b border-slate-100 pb-3">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h4 className="text-base font-bold text-slate-900">Part 2: Defense Pressure Points</h4>
        ...
        {/* 4. PART 3: ANTICIPATED CARRIER POSITION */}
            ...
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-xs font-bold uppercase tracking-wider text-indigo-400">
                  Part 3: Anticipated Carrier Position
                </span>
              </div>
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 shadow-sm">
          <div className="flex items-center justify-between mb-6 border-b border-slate-100 pb-4">
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h4 className="text-lg font-bold text-slate-900">Part 4: Negotiation Strategy & Tactical Playbook</h4>
            ...
            >
              ...
              {copiedId === "strategy-headline" ? "Copied Strategy!" : "Copy Tactical Directives"}
            </button>
          </div>
        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-sm z-50 flex justify-end animate-in fade-in">
          <div className="bg-white w-full max-w-2xl h-full shadow-2xl flex flex-col p-6 overflow-y-auto">
            ...
            <div className="pt-4 border-t border-slate-200">
              <button
                onClick={() => { setShowOutcomeDrawer(false); setShowOutcomeModal(true); }}
                className="w-full py-2.5 bg-teal-900 hover:bg-teal-800 text-white rounded-xl text-xs font-bold transition-colors cursor-pointer"
              >
                + Log Another Settlement Outcome
              </button>
            </div>
          </div>
        </div>
