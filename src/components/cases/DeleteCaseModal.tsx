...
export function DeleteCaseModal({ isOpen, isDeleting, onClose, onConfirm }: DeleteCaseModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-2xl shadow-xl w-full max-w-md overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        <div className="p-6 text-center">
          ...
          <h3 className="text-xl font-bold text-slate-900 mb-2">Delete Case?</h3>
          <p className="text-sm text-slate-500 mb-6">
            Are you sure you want to delete this case? This action cannot be undone and will permanently remove all associated documents and timeline events.
          </p>
