import { getMockCaseById, getMockDocumentsForCase, getMockTimelineForCase } from "@/lib/mock-data"
...
export default async function TimelinePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const baseCase = getMockCaseById(caseId);
  let caseData = null;
  
  if (baseCase) {
    caseData = {
      ...baseCase,
      documents: getMockDocumentsForCase(caseId),
      timelineEvents: getMockTimelineForCase(caseId).sort((a, b) => a.date.getTime() - b.date.getTime())
    };
  }
